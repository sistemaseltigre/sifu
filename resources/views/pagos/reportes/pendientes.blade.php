 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    <div class="x_title">
      <h2>Reporte de pagos pendientes por verificar</h2>
    ...
    <div class="x_content">
      <div class="col-xs-12 col-sm-12">
        <div class="btn-group">
          <a class="btn btn-sm btn-default" type="button" data-placement="top" data-toggle="tooltip" data-original-title="Imprimir"  href="{{ asset('pdf/pagos_pendientes') }}"><i class="fa fa-print fa-2x"></i></a>
        </div>
        <hr>
