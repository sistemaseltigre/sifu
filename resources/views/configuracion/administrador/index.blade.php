...
@section('content')
<script src="js/scripts/administrador.js"> </script>
<div class="panel panel-default">
  ...
  <div class="panel-body" id="contenido-administrador">   
    @include('configuracion.administrador.table')
  </div>
</div>

<div class="modal fade" id="modal-administrador" role="dialog">
      ...
      <div class="modal-body form"> 
        <div class="panel panel-primary">
          <div class="panel-heading">
            <h3 class="panel-title">M&oacute;dulo Administrador</h3>
          </div>
          <div class="panel-body">
            <form class="form-horizontal" id="frmAdministrador"> 
            {{ csrf_field() }}
