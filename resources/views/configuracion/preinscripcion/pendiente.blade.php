<div class="table-responsive">
  ...
  <tbody id="contenido">   
    ...
    <tr>
     ...
     <td><a href="{{ asset('/inscripcion/'.$pendiente->cedula.'/'.$pendiente->idalumno)}}" class="btn btn-primary btn-sm"> <i class="fa fa-check-square" aria-hidden="true"></i> Inscribir</a></td> 
     <td><button class="btn btn-danger btn-sm" onclick="eliminar('{{ $pendiente->idalumno }}')">    <i class="fa fa-minus-square" aria-hidden="true"></i> Rechazar</button></td>
   </tr>
   @endforeach      
 </tbody>
</table>
